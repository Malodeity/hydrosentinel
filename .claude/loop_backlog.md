...
| 2 | Report photo viewer in admin triage | no | pending |
| 3 | Citizen report reference code + public tracking endpoint | yes | pending |
| 4 | CAP due date + overdue alert | yes | pending |
| 5 | Risk trend sparkline (frontend, uses existing history data) | no | pending |
| 6 | Green Drop score display on WSA card | no | pending |
| 7 | Data completeness badge (frontend, null-check existing fields) | no | pending |
